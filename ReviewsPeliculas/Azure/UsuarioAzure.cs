...
using ReviewsPeliculas.Models;
using System.Data;
using System.Data.SqlClient;

namespace ReviewsPeliculas.Azure
{
    public class UsuarioAzure
    {
        ...
        public static Usuario obtenerUsuarioPorNombres(string nombres)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                var comando = ConsultaUserPorNombresSql(connection, nombres);
        ...
        private static SqlCommand ConsultaUserPorNombresSql(SqlConnection connection, string nombres)
        {
        ...
        {
            SqlCommand sqlCommand = new SqlCommand(null, connection);
            sqlCommand.CommandText = $"select * from Administrador where idUsuario = {idUsuario}";
            connection.Open();
            return sqlCommand;
        }
